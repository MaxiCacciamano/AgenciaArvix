                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-16">
                      <div>
                          ...
                          <ul className="space-y-4 text-gray-500 text-[10px] uppercase font-bold tracking-widest">
                              <li><a href="#" className="hover:text-brand-lime transition-colors">Método</a></li>
                              <li><a href="#" className="hover:text-brand-lime transition-colors">Proceso</a></li>
                              <li><a href="#" className="hover:text-brand-lime transition-colors">Paquete</a></li>
                          </ul>
                      </div>
                      <div>
