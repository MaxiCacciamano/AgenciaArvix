                  ...
                  <div className="grid md:grid-cols-12 gap-10">
                      <div className="md:col-span-7">
                          <p className="text-xl md:text-2xl text-gray-400 font-light leading-relaxed mb-12">
                              Desarrollo web estratégico con <span className="text-white font-medium italic underline decoration-brand-lime">investigación de mercado integrada</span>. Si no sabés cómo vende tu competencia, estás perdiendo antes de empezar.
                          </p>
...
>
                          ...
                          <div className="flex flex-wrap gap-y-3">
                              <div className="flex items-center gap-3">
                                  <i data-lucide="search" className="w-5 h-5 text-brand-lime"></i>
                                  <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Benchmark Competitivo</span>
                              </div>
                              <div className="flex items-center gap-3">
                                  <i data-lucide="zap" className="w-5 h-5 text-brand-lime"></i>
                                  <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400">SEO Técnico Nativo</span>
                              </div>
                              <div className="flex items-center gap-3">
                                  <i data-lucide="shield-check" className="w-5 h-5 text-brand-lime"></i>
                                  <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400">30 Días de Optimización</span>
                              </div>
                          </div>
                      </div>
                  </div>
              ...
              <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                  ...
                  <div className="flex items-center gap-4 border-l border-brand-border pl-8">
                      <div className="flex -space-x-2">
                          <div className="w-8 h-8 rounded-full bg-brand-gray border border-brand-border"></div>
                          <div className="w-8 h-8 rounded-full bg-brand-gray border border-brand-border"></div>
                      </div>
                      <p className="text-[10px] text-gray-500 uppercase font-bold leading-tight">
                          "El benchmark nos ahorró meses de <br/>errores." — <span className="text-white">Director en TechCorp</span>
                      </p>
                  </div>
              </div>
          </div>
          ...
          <div className="container mx-auto px-6">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                  <div className="p-10 border border-brand-border bg-brand-gray/30 hover:bg-brand-gray/50 transition-all">
                      <i data-lucide="alert-circle" className="w-8 h-8 text-red-500 mb-6"></i>
                      <h3 className="text-white font-display font-bold text-xl uppercase mb-4">Sin estrategia competitiva</h3>
                      <p className="text-gray-500 text-sm leading-relaxed">Copiás plantillas de otros sin saber por qué ellos venden y vos no. Estás operando a ciegas.</p>
                  </div>
                  <div className="p-10 border border-brand-border bg-brand-gray/30 hover:bg-brand-gray/50 transition-all">
                      <i data-lucide="trending-down" className="w-8 h-8 text-red-500 mb-6"></i>
                      <h3 className="text-white font-display font-bold text-xl uppercase mb-4">Fugas de Conversión</h3>
                      <p className="text-gray-500 text-sm leading-relaxed">Mucho tráfico, cero ventas. Tu diseño es "lindo" pero no guía al usuario hacia la transacción final.</p>
                  </div>
                  <div className="p-10 border border-brand-border bg-brand-gray/30 hover:bg-brand-gray/50 transition-all">
                      <i data-lucide="clock" className="w-8 h-8 text-red-500 mb-6"></i>
                      <h3 className="text-white font-display font-bold text-xl uppercase mb-4">Lentitud Técnica</h3>
                      <p className="text-gray-500 text-sm leading-relaxed">Cada segundo que tarda en cargar, perdés un 20% de tus clientes potenciales. Google te ignora.</p>
                  </div>
              </div>
          </div>
      </section>
                  ...
                  <div className="lg:w-1/2">
                      ...
                      <ul className="space-y-6">
                          ...
                          <li className="flex items-start gap-4">
                              <div className="mt-1 bg-brand-lime p-1 rounded-sm"><i data-lucide="check" className="w-3 h-3 text-black"></i></div>
                              <div>
                                  <span className="block text-white font-bold uppercase text-xs tracking-wider">Arquitectura Escalable</span>
                                  <p className="text-gray-500 text-sm">Webs preparadas para recibir miles de visitas sin colapsar.</p>
                              </div>
                          </li>
                      </ul>
                  </div>
                  <div className="lg:w-1/2 relative">
                      <div className="aspect-square border border-brand-lime/20 flex items-center justify-center p-12">
                          <div className="w-full h-full border border-brand-border relative overflow-hidden group">
                              <div className="absolute inset-0 bg-brand-lime/5 group-hover:bg-brand-lime/10 transition-all"></div>
                              <div className="p-8">
                                  <span className="block text-[10px] font-bold text-brand-lime uppercase tracking-widest mb-4">Competitive Analysis 1.0</span>
                                  <div className="space-y-4">
                                      <div className="h-2 w-full bg-brand-border rounded"></div>
                                      <div className="h-2 w-3/4 bg-brand-border rounded"></div>
                                      <div className="h-2 w-1/2 bg-brand-lime/50 rounded"></div>
                                  </div>
                              </div>
                          </div>
                      </div>
          ...
          <div className="container mx-auto px-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-0 border border-brand-border">
                  <div className="p-10 border-r border-b lg:border-b-0 border-brand-border hover:bg-white hover:text-black transition-all group">
                      <span className="block text-xs font-bold uppercase tracking-widest mb-6 text-brand-lime group-hover:text-black">01 / Investigación</span>
                  ...
                  <div className="p-10 border-r border-b lg:border-b-0 border-brand-border hover:bg-white hover:text-black transition-all group">
                      <span className="block text-xs font-bold uppercase tracking-widest mb-6 text-brand-lime group-hover:text-black">02 / Diseño</span>
                  ...
                  <div className="p-10 border-r border-b md:border-b-0 border-brand-border hover:bg-white hover:text-black transition-all group">
                      <span className="block text-xs font-bold uppercase tracking-widest mb-6 text-brand-lime group-hover:text-black">03 / Tech</span>
                  ...
                  <div className="p-10 hover:bg-white hover:text-black transition-all group">
                      <span className="block text-xs font-bold uppercase tracking-widest mb-6 text-brand-lime group-hover:text-black">04 / Posicionamiento</span>
          ...
          <div className="container mx-auto px-6">
              <div className="grid md:grid-cols-2 gap-12">
                  <div className="p-12 border border-brand-border bg-brand-black">
                      ...
                      <ul className="space-y-4">
                          <li className="flex gap-4 items-center text-sm text-gray-300">
                              <i data-lucide="check-circle" className="w-5 h-5 text-brand-lime"></i>
                  ...
                  <div className="p-12 border border-brand-border bg-brand-black opacity-50">
                      <h3 className="font-display text-2xl font-bold text-white uppercase mb-8">No es para vos si...</h3>
                      <ul className="space-y-4">
                          <li className="flex gap-4 items-center text-sm text-gray-500">
                              <i data-lucide="x-circle" className="w-5 h-5 text-gray-600"></i>
          ...
          <div className="container mx-auto px-6">
              ...
              <div className="space-y-4">
                  <div className="group border-b border-brand-border pb-6 flex gap-10 items-center hover:pl-6 transition-all">
                      <span className="font-display text-3xl font-bold text-brand-border group-hover:text-brand-lime">01</span>
                      <h4 className="text-xl font-bold text-gray-400 group-hover:text-white uppercase transition-colors">Onboarding & Objetivos</h4>
                  </div>
                  <div className="group border-b border-brand-border pb-6 flex gap-10 items-center hover:pl-6 transition-all">
                      <span className="font-display text-3xl font-bold text-brand-border group-hover:text-brand-lime">02</span>
                      <h4 className="text-xl font-bold text-gray-400 group-hover:text-white uppercase transition-colors">Benchmark de Competencia</h4>
                  </div>
                  <div className="group border-b border-brand-border pb-6 flex gap-10 items-center hover:pl-6 transition-all">
                      <span className="font-display text-3xl font-bold text-brand-border group-hover:text-brand-lime">03</span>
                      <h4 className="text-xl font-bold text-gray-400 group-hover:text-white uppercase transition-colors">Arquitectura de Información</h4>
                  </div>
                  <div className="group border-b border-brand-border pb-6 flex gap-10 items-center hover:pl-6 transition-all">
                      <span className="font-display text-3xl font-bold text-brand-border group-hover:text-brand-lime">04</span>
                      <h4 className="text-xl font-bold text-gray-400 group-hover:text-white uppercase transition-colors">Diseño UX/UI de Alta Fidelidad</h4>
                  </div>
                  <div className="group border-b border-brand-border pb-6 flex gap-10 items-center hover:pl-6 transition-all">
                      <span className="font-display text-3xl font-bold text-brand-border group-hover:text-brand-lime">05</span>
                      <h4 className="text-xl font-bold text-gray-400 group-hover:text-white uppercase transition-colors">Desarrollo & QA</h4>
                  </div>
                  <div className="group border-b border-brand-border pb-6 flex gap-10 items-center hover:pl-6 transition-all">
                      <span className="font-display text-3xl font-bold text-brand-border group-hover:text-brand-lime">06</span>
                      <h4 className="text-xl font-bold text-gray-400 group-hover:text-white uppercase transition-colors">Lanzamiento & SEO</h4>
                  </div>
                  <div className="group border-b border-brand-border pb-6 flex gap-10 items-center hover:pl-6 transition-all">
                      <span className="font-display text-3xl font-bold text-brand-border group-hover:text-brand-lime">07</span>
                      <h4 className="text-xl font-bold text-gray-400 group-hover:text-white uppercase transition-colors">Optimización Post-Lanzamiento (30D)</h4>
                  </div>
              </div>
          </div>
      </section>
          ...
          <div className="container mx-auto px-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                  <div className="p-8 bg-brand-black border border-brand-border">
                      <h4 className="font-bold text-white mb-4 uppercase text-xs tracking-widest">SEO Avanzado</h4>
                      <p className="text-gray-500 text-xs leading-relaxed">Posicionamiento de contenido para tráfico orgánico de largo plazo.</p>
                  </div>
                  <div className="p-8 bg-brand-black border border-brand-border">
                      <h4 className="font-bold text-white mb-4 uppercase text-xs tracking-widest">Google Ads (SEM)</h4>
                      <p className="text-gray-500 text-xs leading-relaxed">Tráfico inmediato y segmentado para productos clave.</p>
                  </div>
                  <div className="p-8 bg-brand-black border border-brand-border">
                      <h4 className="font-bold text-white mb-4 uppercase text-xs tracking-widest">Branding</h4>
                      <p className="text-gray-500 text-xs leading-relaxed">Refuerzo de identidad visual para ganar autoridad de marca.</p>
                  </div>
                  <div className="p-8 bg-brand-black border border-brand-border">
                      <h4 className="font-bold text-white mb-4 uppercase text-xs tracking-widest">CRO / Optimización</h4>
                      <p className="text-gray-500 text-xs leading-relaxed">Análisis de mapas de calor para maximizar cada dólar invertido.</p>
                  </div>
              </div>
          </div>
      </section>
      ...
      <section id="paquete" className="py-32 bg-brand-lime text-black relative z-10 overflow-hidden">
          <div className="container mx-auto px-6">
              <div className="bg-black text-white p-12 md:p-20 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                      <span className="bg-brand-lime text-black px-4 py-1 text-[10px] font-black uppercase tracking-widest mb-10 inline-block">Plan Recomendado</span>
                      ...
                      <div className="grid md:grid-cols-2 gap-12 items-end">
                          <div>
                              <ul className="space-y-4 mb-12">
                                  <li className="flex gap-3 items-center text-sm font-bold uppercase tracking-wide"><i data-lucide="check" className="w-5 h-5 text-brand-lime"></i> Desarrollo Web Premium</li>
                                  <li className="flex gap-3 items-center text-sm font-bold uppercase tracking-wide"><i data-lucide="check" className="w-5 h-5 text-brand-lime"></i> Informe de Benchmark (5 Competidores)</li>
                                  <li className="flex gap-3 items-center text-sm font-bold uppercase tracking-wide"><i data-lucide="check" className="w-5 h-5 text-brand-lime"></i> Setup SEO Técnico Avanzado</li>
                                  <li className="flex gap-3 items-center text-sm font-bold uppercase tracking-wide"><i data-lucide="check" className="w-5 h-5 text-brand-lime"></i> Soporte & Optimización Post-Venta</li>
                              </ul>
          ...
          <div className="absolute -bottom-10 -left-10 text-[20rem] font-black text-black opacity-5 pointer-events-none select-none uppercase">PRO</div>
      </section>
      ...
      <section id="contacto" className="py-32 bg-brand-black relative grid-bg">
          <div className="container mx-auto px-6 text-center">
              ...
              <div className="mt-12 flex items-center justify-center gap-2 opacity-40">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-white">Método validado por expertos argentinos</span>
              </div>
          </div>
      </section>
