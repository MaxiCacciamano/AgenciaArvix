...
export default function Home() {
    ...
    const message = encodeURIComponent(
        'Hola, quiero solicitar el diagnóstico sin costo para mi negocio'
    );

    const waCotizacionWeb = encodeURIComponent(
        "Hola, quiero cotizar el desarrollo de un sitio web profesional. ¿Podemos ver opciones y presupuesto?"
    );
                        ...
                        <div className="grid md:grid-cols-0 gap-0 items-center">
                            <div className="md:col-span-6">
                                ...
                                <div className="flex flex-col items-start gap-4 mb-16">
                                    ...
                                    <a
                                        href={`https://wa.me/${WA_PHONE}?text=${waCotizacionWeb}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        aria-label="Cotizar desarrollo web por WhatsApp"
                                    ...
                                    <span className="block mt-3 text-[10px] uppercase tracking-widest text-gray-500">
