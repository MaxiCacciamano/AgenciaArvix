...
import { Target, Zap, Database, ChevronRight, BarChart3 } from 'lucide-react';
        ...
        <div className="bg-brand-black text-brand-white antialiased font-sans">
            ...
            <section className="relative pt-44 pb-32 overflow-hidden border-b border-brand-border">
                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    <div className="max-w-5xl">
                        ...
                        <h1 className="font-display font-bold text-6xl md:text-8xl lg:text-[100px] leading-[0.9] uppercase tracking-tighter mb-10">
                            Dominamos la <br />
                            <span className="text-brand-lime italic">Publicidad Google.</span> <br />
                            <span className="text-outline">Escalamos su</span> <span className="relative">ROI.</span>
                        </h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mt-16">
                            <p className="text-xl text-gray-400 font-light leading-relaxed border-l border-brand-lime pl-8">
                                ...
                                <span className="text-white font-medium italic">publicidad en Google Ads</span> donde la
                                ingeniería de datos y la gestión de anuncios se fusionan para liderar el mercado en Argentina y LATAM.
                            </p>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                        <div className="max-w-xl">
                            ...
                            <h2 className="text-4xl md:text-5xl font-display font-bold uppercase leading-none">
                                INGENIERÍA EN <br/> PUBLICIDAD GOOGLE ADS
                            </h2>
                        </div>
                        <div className="text-gray-500 font-mono text-sm max-w-xs">
                            [01] Smart Bidding Estratégico <br />
                            [02] Anuncios Google de Alta Intención <br />
                            [03] Auditoría de Google Ads Precios
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-brand-border">
                        <div className="p-10 border-b md:border-b-0 md:border-r border-brand-border transition-all hover:bg-zinc-950 group">
                            ...
                            <p className="text-gray-400 text-1xl leading-relaxed mb-8">
                                Dominio total de la publicidad en Google. Identificamos términos con alta intención de compra en Argentina y global, optimizando cada clic.
                            </p>
                        ...
                        <div className="p-10 border-b md:border-b-0 md:border-r border-brand-border transition-all hover:bg-zinc-950 group">
                            ...
                            <p className="text-gray-400 text-1xl leading-relaxed mb-8">
                                El clic es solo el inicio. Optimizamos sus Landing Pages para asegurar que sus anuncios Google Ads conviertan tráfico en facturación real.
                            </p>
                        ...
                        <div className="p-10 transition-all hover:bg-zinc-950 group">
                            ...
                            <p className="text-gray-400 text-1xl leading-relaxed mb-8">
                                Análisis profundo de Google Ads precios y costos por adquisición (CPA). Eliminamos el desperdicio presupuestario.
                            </p>
            ...
            <section id="stack" className="py-24 bg-brand-gray relative">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-500 mt-4 text-1xl font-mono uppercase tracking-widest">
                            PLATAFORMAS DE PUBLICIDAD LÍDERES
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 opacity-40">
                        <div className="flex items-center justify-center grayscale hover:grayscale-0 transition-all">
                            <span className="text-2xl font-black uppercase tracking-tighter text-brand-lime">Google Ads</span>
                        </div>
                        <div className="flex items-center justify-center grayscale hover:grayscale-0 transition-all">
                            <span className="text-2xl font-black uppercase tracking-tighter">Analytics 4</span>
                        </div>
                        <div className="flex items-center justify-center grayscale hover:grayscale-0 transition-all">
                            <span className="text-2xl font-black uppercase tracking-tighter">Merchant Center</span>
                        </div>
                        <div className="flex items-center justify-center grayscale hover:grayscale-0 transition-all">
                            <span className="text-2xl font-black uppercase tracking-tighter">Looker Studio</span>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div>
                            ...
                            <div className="space-y-12">
                                <div className="relative pl-16">
                                    ...
                                    <h4 className="text-xl font-bold uppercase mb-2">MINERÍA DE KEYWORDS</h4>
                                    <p className="text-gray-400 text-sm">
                                        Extraemos los términos exactos para su publicidad en Google, filtrando el tráfico basura para optimizar su inversión.
                                    </p>
                                </div>
                                <div className="relative pl-16">
                                    <span className="absolute left-0 top-0 text-5xl font-display font-black text-brand-border">
                                    ...
                                    <h4 className="text-xl font-bold uppercase mb-2">INGENIERÍA DE ANUNCIOS</h4>
                                    <p className="text-gray-400 text-1xl">
                                        Redactamos anuncios de Google Ads que detienen el scroll y obligan al click mediante gatillos mentales de alta performance.
                                    </p>
                                </div>
                                <div className="relative pl-16">
                                    <span className="absolute left-0 top-0 text-5xl font-display font-black text-brand-border">
                                    ...
                                    <h4 className="text-xl font-bold uppercase mb-2">ESCALADO DE PUJAS (BIDDING)</h4>
                                    <p className="text-gray-400 text-1xl">
                                        Ajustamos sus precios de subasta en tiempo real para dominar la primera posición cuando la rentabilidad está asegurada.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="relative">
                            <div className="aspect-square bg-zinc-900 border border-brand-border flex items-center justify-center p-12 group overflow-hidden">
                                ...
                                <div className="absolute top-0 right-0 p-4 font-mono text-[8px] text-gray-700">
                                    SYS_LOG: OPTIMIZING_CAMPAIGN_AR...
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="cta" className="py-32 relative overflow-hidden">
                <div className="container mx-auto px-6 text-center relative z-10">
                    <h2 className="font-display font-bold text-5xl md:text-7xl lg:text-8xl leading-[0.9] text-white tracking-tighter uppercase mb-10">
                        ¿Busca resultados en <br /> <span className="italic text-brand-lime">Google Ads?</span>
                    </h2>
                    <p className="text-gray-400 max-w-2xl mx-auto mb-12 text-lg">
                        No aceptamos a todos los clientes. Solo trabajamos con marcas en Argentina y el mundo listas para escalar mediante publicidad de precisión.
                    </p>
