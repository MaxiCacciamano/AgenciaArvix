...
export const Nosotros = () => {
    const whatsappQuestion = encodeURIComponent(
        "Hola, tengo otra pregunta sobre diseño web"
    );

    const whatsappdiagnostico = encodeURIComponent(
        "Hola, quiero crear mi sitio web y me gustaría recibir asesoramiento. ¿Cómo seguimos?"
    );

    const whatsappremodelacion = encodeURIComponent(
         "Hola, tengo un sitio web y quiero remodelarlo para que convierta mejor. ¿Podemos coordinar una asesoría?"
    );
                ...
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-12 gap-20">
                        <div className="lg:col-span-5">
                            ...
                            <a
                                href={`https://wa.me/543532679392?text=${whatsappQuestion}`}
                                target="_blank"
            ...
            <section className="py-32 bg-brand-lime text-black text-center relative overflow-hidden">
                <div className="container mx-auto px-6  relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <a
                            href={`https://wa.me/543532679392?text=${whatsappdiagnostico}`}
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        <a
                            href={`https://wa.me/543532679392?text=${whatsappremodelacion}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Solicitar asesoramiento por whatsapp para remodelar sitio web"
