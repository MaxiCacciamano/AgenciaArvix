        ...
        <div className="container mx-auto px-6">
            <div className="max-w-5xl">
                ...
                <h1 className="font-display font-bold text-6xl md:text-8xl lg:text-9xl leading-[0.85] uppercase tracking-tighter mb-10">
                    ...
                    <span className="text-brand-lime italic">más linda.</span>
                </h1>
                <p className="text-xl md:text-2xl text-gray-400 max-w-2xl font-light mb-12">
                    Necesita convertir visitas en clientes. Desarrollamos desde cero o remodelamos tu arquitectura actual para escalar ventas y optimizar tu **ROI**.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    <h2 className="font-display text-4xl md:text-6xl font-bold uppercase tracking-tighter mb-8">
                        ¿Tu sitio actual <span className="text-brand-lime italic">te está frenando?</span>
                    </h2>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="space-y-4">
                <div className="border border-brand-border p-6 hover:bg-white/5 transition-all cursor-pointer">
                    <h4 className="font-bold text-sm uppercase tracking-wider mb-2">¿Cuánto tiempo lleva remodelar una tienda?</h4>
