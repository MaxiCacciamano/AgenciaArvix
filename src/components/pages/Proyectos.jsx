...
export const Proyectos = () => {
  return (
    <div classNameName="bg-brand-black text-brand-white antialiased selection:bg-brand-lime selection:text-black">
        <Menu/>

    <header className="relative pt-40 pb-20-b-brand-border overflow-hidden">
        <div className="w-full relative z-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                ...
                <div className="flex flex-wrap gap-4 text-[9px] font-black uppercase tracking-[0.2em]">
                    ...
                    <button className="px-4 py-2-brand-border text-gray-400 hover:border-brand-lime transition-colors">Logística</button>
                    <button className="px-4 py-2-brand-border text-gray-400 hover:border-brand-lime transition-colors">Finanzas</button>
                    <button className="px-4 py-2-brand-border text-gray-400 hover:border-brand-lime transition-colors">B2B SaaS</button>
                </div>
            </div>
        </div>
    ...
    <section id="proyectos" className="py-20 bg-brand-black">
        <div className="w-full">
            <div className="grid md:grid-cols-2 gap-px bg-brand-border-brand-border">
                ...
                <div className="bg-brand-black group project-card overflow-hidden">
                    ...
                    <div className="p-10-t-brand-border transition-colors duration-500 project-info">
    ...
    <section className="py-24 bg-brand-dark-y-brand-border">
        <div className="w-full">
    ...
    <section className="py-32 bg-brand-black relative overflow-hidden text-center">
        <div className="w-full relative z-10">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center">
                ...
                <a href="nosotros.html" className="border-brand-border text-white px-12 py-6 font-black uppercase tracking-widest text-sm hover:bg-brand-gray transition-colors">
                    Nuestra Metodología
                </a>
            </div>
        </div>
