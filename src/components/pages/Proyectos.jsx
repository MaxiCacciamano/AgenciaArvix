  ...
  return (
    <div className="bg-brand-black text-brand-white antialiased selection:bg-brand-lime selection:text-black">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <span class="text-brand-lime text-[10px] font-black uppercase tracking-[0.3em] mb-6 block">Soluciones de Negocio</span>
            <h1 class="font-display font-bold text-6xl md:text-8xl lg:text-9xl leading-[0.85] text-white tracking-tighter uppercase mb-12">
                Impacto en<br/><span class="italic text-brand-lime">Negocios.</span>
            </h1>
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                ...
                <div class="flex flex-wrap gap-4 text-[9px] font-black uppercase tracking-[0.2em]">
                    ...
                    <button class="px-4 py-2 border border-brand-border text-gray-400 hover:border-brand-lime transition-colors">Logística</button>
                    <button class="px-4 py-2 border border-brand-border text-gray-400 hover:border-brand-lime transition-colors">Finanzas</button>
                    <button class="px-4 py-2 border border-brand-border text-gray-400 hover:border-brand-lime transition-colors">B2B SaaS</button>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-px bg-brand-border border border-brand-border">
                ...
                <div class="bg-brand-black group project-card overflow-hidden">
                    ...
                    <div class="p-10 border-t border-brand-border transition-colors duration-500 project-info">
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <span class="text-brand-lime text-[10px] font-black uppercase tracking-[0.2em] mb-2 block">Supply Chain & Logistics</span>
                                <h3 class="text-3xl font-display font-bold uppercase text-white tracking-tighter">Atlas Logística</h3>
                            </div>
                ...
                <div class="bg-brand-black group project-card overflow-hidden">
                    ...
                    <div class="p-10 border-t border-brand-border transition-colors duration-500 project-info">
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <span class="text-brand-lime text-[10px] font-black uppercase tracking-[0.2em] mb-2 block">Investment Banking</span>
                                <h3 class="text-3xl font-display font-bold uppercase text-white tracking-tighter">Prime Equity</h3>
                            </div>
                            <span class="text-gray-600 font-display italic text-xl">2023</span>
                        </div>
                        <p class="text-gray-500 text-sm mb-8 leading-relaxed max-w-md">
                ...
                <div class="bg-brand-black group project-card overflow-hidden">
                    ...
                    <div class="p-10 border-t border-brand-border transition-colors duration-500 project-info">
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <span class="text-brand-lime text-[10px] font-black uppercase tracking-[0.2em] mb-2 block">Energy & Utilities</span>
                                <h3 class="text-3xl font-display font-bold uppercase text-white tracking-tighter">Innova Energy</h3>
                            </div>
                            <span class="text-gray-600 font-display italic text-xl">2023</span>
                        </div>
                        <p class="text-gray-500 text-sm mb-8 leading-relaxed max-w-md">
                ...
                <div class="bg-brand-black group project-card overflow-hidden">
                    ...
                    <div class="p-10 border-t border-brand-border transition-colors duration-500 project-info">
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <span class="text-brand-lime text-[10px] font-black uppercase tracking-[0.2em] mb-2 block">Professional Services</span>
                                <h3 class="text-3xl font-display font-bold uppercase text-white tracking-tighter">Global Partners</h3>
                            </div>
                            <span class="text-gray-600 font-display italic text-xl">2024</span>
                        </div>
                        <p class="text-gray-500 text-sm mb-8 leading-relaxed max-w-md">
    ...
    <section class="py-32 bg-brand-black relative overflow-hidden text-center">
        <div class="container mx-auto px-6 relative z-10">
            <h2 class="font-display text-4xl md:text-7xl font-black uppercase mb-12 tracking-tighter max-w-5xl mx-auto leading-none">
                Transformamos tu infraestructura en una <span class="text-brand-lime italic">máquina de crecimiento.</span>
            </h2>
            <div class="flex flex-col md:flex-row gap-6 justify-center">
                <a href="index.html#contacto" class="bg-brand-lime text-black px-12 py-6 font-black uppercase tracking-widest text-sm hover:scale-105 transition-transform">
                    Solicitar Diagnóstico B2B
                </a>
                <a href="nosotros.html" class="border border-brand-border text-white px-12 py-6 font-black uppercase tracking-widest text-sm hover:bg-brand-gray transition-colors">
                    Nuestra Metodología
                </a>
            </div>
        </div>
        <div class="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.02]">
            <i data-lucide="briefcase" class="w-[500px] h-[500px] text-white"></i>
        </div>
    </section>
    <Footer />
    </div>
