                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                        ...
                        <div className="flex flex-wrap gap-4 text-[9px] font-black uppercase tracking-[0.2em]">
                            ...
                            <span className="px-4 py-2 border border-brand-border text-gray-400">Content Strategy</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="md:col-span-2 bento-card p-8 flex flex-col justify-between group">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm leading-relaxed">
                                    Transformamos el tráfico en revenue. Somos la SEO Agencia que entiende de negocios, no solo de algoritmos.
                                </p>
                            </div>
                        </div>
                    </div>
