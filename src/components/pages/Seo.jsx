        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                ...
                <div className="flex flex-wrap gap-4 text-[9px] font-black uppercase tracking-[0.2em]">
                    ...
                    <button className="px-4 py-2 border border-brand-border text-gray-400 hover:border-brand-lime transition-colors">SEO Técnico</button>
                    ...
                    <button className="px-4 py-2 border border-brand-border text-gray-400 hover:border-brand-lime transition-colors">Estratégico</button>
                </div>
            </div>
        </div>
        ...
        <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                <div className="md:col-span-4 bento-card p-8 md:p-12 relative overflow-hidden group">
                    ...
                    <div className="absolute right-0 top-0 w-1/2 h-full bg-gradient-to-l from-brand-lime/5 to-transparent pointer-events-none"></div>
                </div>
                ...
                <div className="md:col-span-2 bento-card p-8 flex flex-col justify-between group">
                    ...
                    <div className="mt-6 flex items-baseline gap-2">
                        ...
                        <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">ROI Orgánico</span>
                    </div>
                </div>
                ...
                <div className="md:col-span-3 bento-card p-8 relative overflow-hidden group">
                    <div className="relative z-10 h-full flex flex-col justify-between">
                        <div className="flex justify-between">
                            <h4 className="text-white font-display font-bold text-lg uppercase">Expansión de <br/>Mercados</h4>
                            <div className="flex -space-x-2">
                                <div className="w-6 h-6 rounded-full border border-brand-black bg-gray-800 flex items-center justify-center text-[8px] font-bold">ES</div>
                                <div className="w-6 h-6 rounded-full border border-brand-black bg-gray-700 flex items-center justify-center text-[8px] font-bold">EN</div>
                                <div className="w-6 h-6 rounded-full border border-brand-black bg-gray-600 flex items-center justify-center text-[8px] font-bold">PT</div>
                            </div>
                        </div>
                        <div className="mt-8 flex items-end gap-1 h-20">
                            <div className="graph-bar w-full bg-brand-border h-[20%] group-hover:h-[40%] group-hover:bg-brand-lime"></div>
                            <div className="graph-bar w-full bg-brand-border h-[35%] group-hover:h-[60%] group-hover:bg-brand-lime"></div>
                            <div className="graph-bar w-full bg-brand-border h-[25%] group-hover:h-[55%] group-hover:bg-brand-lime"></div>
                            <div className="graph-bar w-full bg-brand-border h-[45%] group-hover:h-[80%] group-hover:bg-brand-lime"></div>
                            <div className="graph-bar w-full bg-brand-border h-[60%] group-hover:h-[100%] group-hover:bg-brand-lime"></div>
                            <div className="graph-bar w-full bg-brand-border h-[40%] group-hover:h-[90%] group-hover:bg-brand-lime"></div>
                        </div>
                        <p className="text-gray-500 text-[10px] uppercase font-bold tracking-widest mt-6">Crecimiento en Indexación Internacional</p>
                    </div>
                </div>
            </div>
        </div>
